 ...
 */
          ...
          // Four buttons: Add Cards, Set, New Game, Pause
         ...
         // Timer information
          ...
          public final String keyOptions = "q, w, e, r, [t, y, u]: top row;\na, s, d, f, [g, h, j]: second row;\n" +
                                                                 ...
                                                                 "+ to add cards, - to find a set, SPACE to pause, ENTER/RETURN for a 
				           new  game";                            
          ...
          void draw() {
      	  ...
      	  void drawCard(int cardCol, int cardRow, int xpos, int ypos) {
               image(cimg, xpos, ypos, CARD_WIDTH+CARD_X_SPACER, CARD_HEIGHT+CARD_Y_SPACER,
                        ...
                        (cardRow+1)*CARD_HEIGHT+CARD_Y_SPACER);
          }
...
drawCard(col, row, col*(CARD_WIDTH+CARD_X_SPACER),                      row*(CARD_HEIGHT+CARD_Y_SPACER));
	...
	rect(BUTTON_LEFT_OFFSET+i*(BUTTON_WIDTH+12), BUTTON_TOP_OFFSET, BUTTON_WIDTH,   
	BUTTON_HEIGHT);
            }
            ...
            text("New Game", BUTTON_LEFT_OFFSET+18+2*(BUTTON_WIDTH+12), 
           BUTTON_TOP_OFFSET+22);
            if (state == State.PAUSED) {
              text("Resume", BUTTON_LEFT_OFFSET+45+3*(BUTTON_WIDTH+12),  
             BUTTON_TOP_OFFSET+22);
            } else {
...
public void newGame() {
    ...
    state = State.PLAYING
    message = 0;
    for(int cardNum = 0; cardNum < ROWS * currentCols; cardNum++) {
        Card card = deck.deal();
