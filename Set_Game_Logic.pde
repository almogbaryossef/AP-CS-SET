...
boolean diffColor(Card a, Card b, Card c) {
  return (!(a.getColor().equals(b.getColor())) && !(a.getColor().equals(c.getColor())) && !(b.getColor().equals(c.getColor())));
}

boolean diffShape(Card a, Card b, Card c) {
  return (!(a.getShape().equals(b.getShape())) && !(a.getShape().equals(c.getShape())) && !(b.getShape().equals(c.getShape())));
}

boolean diffFill(Card a, Card b, Card c) {
  return (!(a.getFill().equals(b.getFill())) && !(a.getFill().equals(c.getFill())) && !(b.getFill().equals(c.getFill())));
}

boolean diffCount(Card a, Card b, Card c) {
  return (!(a.getCount().equals(b.getCount())) && !(a.getCount().equals(c.getCount())) && !(b.getCount().equals(c.getCount())));
}  
